...
*/
void EEPROM_ReadBlockFromAddress(const u16 u16Address, u8* dist,const u16 size);
...
*/
void EEPROM_WriteByteToAddress(const u16 u16Address, const u8 u8Data);
...
*/
void EEPROM_WriteBlockToAddress(const u16 u16Address, const u8* u8Data,const u16 size);
